	...
	{jstabs}
		{jstab title="Blog Features"}
			{legend legend="Home Blog"}
				...
				<div class="control-group submit">
					<input type="submit" class="ink-button" name="set_blog_home" value="{tr}Change preferences{/tr}" />
				</div>
			{/legend}
			...
			{legend legend="Blog Features"}
				...
				<div class="control-group submit">
					<input type="submit" class="ink-button" name="featuresTabSubmit" value="{tr}Change preferences{/tr}" />
				</div>
			{/legend}
		{/jstab}
		...
		{jstab title="List Settings"}
			{legend legend="List Settings"}
				...
				<div class="control-group submit">
					<input type="submit" class="ink-button" name="listTabSubmit" value="{tr}Change preferences{/tr}" />
				</div>
			{/legend}
		{/jstab}
	{/jstabs}
